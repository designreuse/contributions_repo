   ...
   <div class="col-md-6 col-sm-6 col-xs-12">
     ...
     <div class="col-md-6 col-sm-6 col-xs-12">
       <div class="info-box">
         <span class="info-box-icon bg-aqua"><i class="ion ion-card"></i></span>
         <div class="info-box-content">
           <span class="info-box-text">G7 Member Details</span>
           <span class="info-box-number">
            <small class="text-muted">Shows the Details of a G7 Member</small>
           </span>
            <a href="<c:url value="/protected/g7Members"/>" class="btn btn-primary">Define</a>
         </div><!-- /.info-box-content -->
       </div><!-- /.info-box -->
     </div>
