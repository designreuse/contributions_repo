...
<form:form class="form-horizontal" role="form" modelAttribute="organization"
                   ...
                   <div class="box-body">
				        ...
				        <input type="submit"  class="btn btn-primary" id="btnSaveProduct" value="Save" >
				        <hr>
				        ...
				        <div class="col-md-6">
		                 <label for="countryName" class="control-label col-md-5">Country</label>
		                    <div class="col-md-7">
		                     ...
		                     <form:input  path="address.country.couName" name="countryName" class="form-control" id="txtCountry" disabled="true"/>
		                     <form:hidden path="address.country.couCode" id="txtCountryCode"/>
		                      <span class="input-group-btn">
						        <button class="btn btn-default" type="button" onclick="showCountryPop();"> 
		                 ...
		                 <label for="countyName" class="control-label col-md-5">County</label>
		                    <div class="col-md-7">
		                     ...
		                     <form:hidden path="address.county.countyId" id="txtCountyCode"/>
		                      <span class="input-group-btn">
						        <button class="btn btn-default" type="button" onclick="showCountyPop();"> 
						          <i class="fa fa-search"></i>
						        </button>
						      </span>
		                     </div>                  
		                 ...
		                 <label for="cityName" class="control-label col-md-5">City</label>
		                    <div class="col-md-7">
		                     ...
		                     <form:hidden path="address.town.ctCode" id="txtCityCode"/>
		                      <span class="input-group-btn">
						        <button class="btn btn-default" type="button" onclick="showTownPop();"> 
						          <i class="fa fa-search"></i>
						        </button>
						      </span>
		                     </div>                  
		                 ...
		                 <label for="currencyName" class="control-label col-md-5">Currency</label>
		                    <div class="col-md-7">
		                     ...
		                     <form:hidden path="currency.curCode" id="txtCurCode"/>
		                      <span class="input-group-btn">
						        <button class="btn btn-default" type="button" onclick="showCurrencyPop();"> 
						          <i class="fa fa-search"></i>
						        </button>
						      </span>
		                     </div>                  
